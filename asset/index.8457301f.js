    ...
    modules: [s, t, r, function({
        ...
        t({
            ...
            const {
                scaleStep: s,
                opacityStep: t
            } = e.params.carouselEffect, r = Math.max(Math.min(e.params.carouselEffect.sideSlides, 3), 1), a = {
                1: 2,
                2: 1,
                3: .2
            }[r], o = {
            ...
            for (let l = 0; l < e.slides.length; l += 1) {
                ...
                n.style.transform = `translateX(${f}) scale(${m})`, n.style.zIndex = y, n.style.opacity = p > r + 1 ? 0 : 1, u.forEach((e => {
