var e = Object.defineProperty,
    ...
    l = (e, t) => {
        ...
        if (i)
            for (var s of i(t)) r.call(t, s) && n(e, s, t[s]);
        return e
    },
    o = (e, i) => t(e, s(i));
...
function D(e) {
    return void 0 === e && (e = {}), O || (O = function(e) {
        ...
        const p = r.match(/(iPod)(.*OS\s([\d_]+))?/),
            ...
            m = "Win32" === a;
        let h = "MacIntel" === a;
        return !c && h && s.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${l}x${o}`) >= 0 && (c = r.match(/(Version)\/([\d.]+)/), c || (c = [0, 1, "13_0_0"]), h = !1), d && !m && (n.os = "android", n.android = !0), (c || u || p) && (n.os = "ios", n.ios = !0), n
    }(e)), O
}
    ...
    F = e => {
        ...
        if (e.params.rewind || e.params.loop)
            for (let n = a - t; n <= r + t; n += 1) {
                ...
                for (let n = Math.max(a - t, 0); n <= Math.min(r + t, s - 1); n += 1) n !== a && (n > r || n < a) && $(e, n)
    };
...
function V(e) {
    ...
    Object.assign(a, {
        ...
        isScrolling: void 0,
        startMoving: void 0
    }), n.startX = h, n.startY = v, a.touchStartTime = g(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, r.threshold > 0 && (a.allowThresholdMove = !1);
    let w = !0;
...
function H(e) {
    ...
    if (void 0 === i.isScrolling) {
        let e;
        s.isHorizontal() && r.currentY === r.startY || s.isVertical() && r.currentX === r.startX ? i.isScrolling = !1 : m * m + f * f >= 25 && (e = 180 * Math.atan2(Math.abs(f), Math.abs(m)) / Math.PI, i.isScrolling = s.isHorizontal() ? e > a.touchAngle : 90 - e > a.touchAngle)
    }
...
function j(e) {
    ...
    if (p > r.longSwipesMs) {
        ...
        "next" === t.swipeDirection && (b >= r.longSwipesRatio ? t.slideTo(r.rewind && t.isEnd ? v : m + y) : t.slideTo(m)), "prev" === t.swipeDirection && (b > 1 - r.longSwipesRatio ? t.slideTo(m + y) : null !== w && b < 0 && Math.abs(b) > r.longSwipesRatio ? t.slideTo(w) : t.slideTo(m))
    } else {
        if (!r.shortSwipes) return void t.slideTo(t.activeIndex);
        t.navigation && (a.target === t.navigation.nextEl || a.target === t.navigation.prevEl) ? a.target === t.navigation.nextEl ? t.slideTo(m + y) : t.slideTo(m) : ("next" === t.swipeDirection && t.slideTo(null !== v ? v : m + y), "prev" === t.swipeDirection && t.slideTo(null !== w ? w : m))
    }
}
...
const U = (e, t) => {
    ...
    s[o]("touchstart", e.onDocumentTouchStart, {
        ...
        passive: !0
    }), (i.preventClicks || i.preventClicksPropagation) && a[o]("click", e.onClick, !0), i.cssMode && r[o]("scroll", e.onScroll), i.updateOnWindowResize ? e[d](n.ios || n.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", R, !0) : e[d]("observerUpdate", R, !0), a[o]("load", e.onLoad, {
        capture: !0
    })
};
...
const Z = {
        ...
        update: {
            updateSize: function() {
                ...
                let t, s;
                const i = e.el;
                t = void 0 !== e.params.width && null !== e.params.width ? e.params.width : i.clientWidth, s = void 0 !== e.params.height && null !== e.params.height ? e.params.height : i.clientHeight, 0 === t && e.isHorizontal() || 0 === s && e.isVertical() || (t = t - parseInt(M(i, "padding-left") || 0, 10) - parseInt(M(i, "padding-right") || 0, 10), s = s - parseInt(M(i, "padding-top") || 0, 10) - parseInt(M(i, "padding-bottom") || 0, 10), Number.isNaN(t) && (t = 0), Number.isNaN(s) && (s = 0), Object.assign(e, {
                    width: t,
                    height: s,
            ...
            updateSlides: function() {
                ...
                let b = s.spaceBetween,
                    ...
                    x = 0;
                if (void 0 === r) return;
                "string" == typeof b && b.indexOf("%") >= 0 ? b = parseFloat(b.replace("%", "")) / 100 * r : "string" == typeof b && (b = parseFloat(b)), e.virtualSize = -b, c.forEach((e => {
                ...
                for (let S = 0; S < p; S += 1) {
                    ...
                    if (P = 0, c[S] && (i = c[S]), C && e.grid.updateSlide(S, i, c), !c[S] || "none" !== M(i, "display")) {
                        ...
                        c[S] && (c[S].swiperSlideSize = P), f.push(P), s.centeredSlides ? (y = y + P / 2 + T / 2 + b, 0 === T && 0 !== S && (y = y - r / 2 - b), 0 === S && (y = y - r / 2 - b), Math.abs(y) < .001 && (y = 0), s.roundLengths && (y = Math.floor(y)), x % s.slidesPerGroup == 0 && u.push(y), m.push(y)) : (s.roundLengths && (y = Math.floor(y)), (x - Math.min(e.params.slidesPerGroupSkip, x)) % e.params.slidesPerGroup == 0 && u.push(y), m.push(y), y = y + P + b), e.virtualSize += P + b, T = P, x += 1
                    }
                }
                if (e.virtualSize = Math.max(e.virtualSize, r) + g, n && l && ("slide" === s.effect || "coverflow" === s.effect) && (i.style.width = `${e.virtualSize+b}px`), s.setWrapperSize && (i.style[e.getDirectionLabel("width")] = `${e.virtualSize+b}px`), C && e.grid.updateWrapperSize(P, u), !s.centeredSlides) {
                    const t = [];
                ...
                if (p !== d && e.emit("slidesLengthChange"), u.length !== v && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), m.length !== w && e.emit("slidesGridLengthChange"), s.watchSlidesProgress && e.updateSlidesOffset(), !(o || s.cssMode || "slide" !== s.effect && "fade" !== s.effect)) {
            ...
            updateSlidesProgress: function(e) {
                ...
                for (let o = 0; o < i.length; o += 1) {
                    ...
                    (u >= 0 && u < t.size - 1 || m > 1 && m <= t.size || u <= 0 && m >= t.size) && (t.visibleSlides.push(e), t.visibleSlidesIndexes.push(o), i[o].classList.add(s.slideVisibleClass)), f && i[o].classList.add(s.slideFullyVisibleClass), e.progress = a ? -c : c, e.originalProgress = a ? -p : p
                }
            },
            ...
            updateActiveIndex: function(e) {
                ...
                Object.assign(t, {
                    ...
                    previousIndex: r,
                    activeIndex: d
                }), t.initialized && F(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), (t.initialized || t.params.runCallbacksOnInit) && (n !== u && t.emit("realIndexChange"), t.emit("slideChange"))
            },
        ...
        slide: {
            ...
            slideToClickedSlide: function() {
                ...
                if (t.loop) {
                    ...
                    a = parseInt(e.clickedSlide.getAttribute("data-swiper-slide-index"), 10), t.centeredSlides ? r < e.loopedSlides - i / 2 || r > e.slides.length - e.loopedSlides + i / 2 ? (e.loopFix(), r = e.getSlideIndex(E(s, `${n}[data-swiper-slide-index="${a}"]`)[0]), h((() => {
                        e.slideTo(r)
                    }))) : e.slideTo(r) : r > e.slides.length - i ? (e.loopFix(), r = e.getSlideIndex(E(s, `${n}[data-swiper-slide-index="${a}"]`)[0]), h((() => {
                        e.slideTo(r)
                    }))) : e.slideTo(r)
                } else e.slideTo(r)
            }
                ...
                if (c.__preventObserver__ = !0, requestAnimationFrame((() => {
                    ...
                    if (S.length > 0 && M) {
                        if (void 0 === t) {
                            ...
                            d ? c.setTranslate(c.translate - t) : (c.slideTo(E + P, 0, !1, !0), a && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t, c.touchEventsData.currentTranslate = c.touchEventsData.currentTranslate - t))
                        } else if (a) {
                    ...
                    if (void 0 === t) {
                        ...
                        d ? c.setTranslate(c.translate - t) : (c.slideTo(E - L, 0, !1, !0), a && (c.touchEventsData.startTranslate = c.touchEventsData.startTranslate - t, c.touchEventsData.currentTranslate = c.touchEventsData.currentTranslate - t))
                    } else {
        ...
        breakpoints: {
            setBreakpoint: function() {
                ...
                }), c && !f ? e.disable() : !c && f && e.enable(), e.currentBreakpoint = n, e.emit("_beforeBreakpoint", l), s && (u ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !m && h ? (e.loopCreate(t), e.updateSlides()) : m && !h && e.loopDestroy()), e.emit("breakpoint", l)
            },
...
class te {
    constructor() {
        ...
        }), n.browser = G(), n.eventsListeners = {}, n.eventsAnyListeners = [], n.modules = [...n.__modules__], t.modules && Array.isArray(t.modules) && n.modules.push(...t.modules);
        const l = {};
        n.modules.forEach((e => {
            e({
                params: t,
        ...
        const o = y({}, J, l);
        return n.params = y({}, o, ee, t), n.originalParams = y({}, n.params), n.passedParams = y({}, t), n.params && n.params.on && Object.keys(n.params.on).forEach((e => {
    ...
    mount(e) {
        ...
        return !a && t.params.createElements && (a = C("div", t.params.wrapperClass), s.append(a), E(s, `.${t.params.slideClass}`).forEach((e => {
            a.append(e)
        }))), Object.assign(t, {
            el: s,
            wrapperEl: a,
...
function re(e) {
    ...
    function u() {
        ...
        if (t.params.loop ? (r = t.previousRealIndex || 0, i = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (i = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, i = t.activeIndex || 0), "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
            ...
            let o, d, u;
            if (s.dynamicBullets && (n = k(a[0], t.isHorizontal() ? "width" : "height", !0), p.forEach((e => {
...
function ne(e) {
    ...
    let o, d, c, p, m, f, h, g, v = l && l.autoplay ? l.autoplay.delay : 3e3,
    ...
    const S = () => {
        ...
        T = e => {
            ...
            const l = i.params.speed,
                d = () => {
                    i && !i.destroyed && (i.params.autoplay.reverseDirection ? !i.isBeginning || i.params.loop || i.params.rewind ? (i.slidePrev(l, !0, !0), n("autoplay")) : i.params.autoplay.stopOnLastSlide || (i.slideTo(i.slides.length - 1, l, !0, !0), n("autoplay")) : !i.isEnd || i.params.loop || i.params.rewind ? (i.slideNext(l, !0, !0), n("autoplay")) : i.params.autoplay.stopOnLastSlide || (i.slideTo(0, l, !0, !0), n("autoplay")), i.params.cssMode && (b = (new Date).getTime(), requestAnimationFrame((() => {
                        T()
                    }))))
                };
    ...
    r("init", (() => {
        ...
        !i.destroyed && i.autoplay.running && (i.params.autoplay.disableOnInteraction ? x() : (c = !0, p = !1, h = !1, m = setTimeout((() => {
            h = !0, p = !0, C(!0)
        }), 200)))
    })), r("touchEnd", (() => {
...
export {
    ne as A, ie as N, re as P, te as S
};